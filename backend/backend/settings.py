...
STATIC_URL = '/static/'
# STATICFILES_DIRS = [
#     BASE_DIR / "frontend" / "dist" / "assets",  # Path to the assets generated by Vite (CSS, JS, etc.)
# ]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Optionally add custom templates directory
        'APP_DIRS': True,  # Enables automatic discovery of templates in app directories
        'OPTIONS': {
            'context_processors': [
