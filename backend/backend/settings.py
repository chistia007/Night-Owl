...
ALLOWED_HOSTS = [os.environ['WEBSITE_HOSTNAME'], 'localhost', '127.0.0.1', 'night-owl-backend.azurewebsites.net']
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "chisthia.khan@g.bracu.ac.bd"
EMAIL_HOST_PASSWORD = "llth azkw yczb rfdj"
